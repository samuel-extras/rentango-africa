        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 lg:items-center">
          <div className="aspect-w-16 aspect-h-6 lg:aspect-none">
            <img
              ...
              src="https://images.unsplash.com/photo-1587614203976-365c74645e83?q=80&w=480&h=500&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
              alt="Features Image"
            />
          </div>
          {/* End Col */}
          ...
          <div>
            ...
            <Button className="group inline-flex items-center gap-x-2 py-2 px-3 bg-[#090857] border border-[#090857] text-white font-medium text-sm rounded-full focus:outline-hidden">
              <svg
